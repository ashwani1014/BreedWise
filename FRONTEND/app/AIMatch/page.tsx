            ...
            <nav className="bg-surface/80 dark:bg-surface-container-highest/80 backdrop-blur-md fixed top-0 w-full z-50 shadow-sm dark:shadow-none">
                <div className="flex justify-between items-center h-20 px-gutter max-w-container-max mx-auto">
                    ...
                    <div className="flex items-center gap-md">
                        <a className="font-headline-lg text-headline-lg font-bold text-primary dark:text-inverse-primary tracking-tight active:scale-95 transition-transform" href="#">
                            Breedwise
                        </a>
                    </div>
                    {/* Navigation Links (Desktop) */}
                    <div className="hidden md:flex items-center gap-md">
                        <a className="text-on-surface-variant dark:text-outline hover:text-primary dark:hover:text-inverse-primary transition-colors font-label-sm text-label-sm hover:bg-primary-container/10 dark:hover:bg-primary-fixed/10 px-sm py-xs rounded-lg active:scale-95 transition-transform" href="#">Discover</a>
                        <a className="text-on-surface-variant dark:text-outline hover:text-primary dark:hover:text-inverse-primary transition-colors font-label-sm text-label-sm hover:bg-primary-container/10 dark:hover:bg-primary-fixed/10 px-sm py-xs rounded-lg active:scale-95 transition-transform" href="#">Marketplace</a>
                        <a className="text-primary dark:text-inverse-primary font-semibold border-b-2 border-primary dark:border-inverse-primary pb-1 font-label-sm text-label-sm px-sm py-xs active:scale-95 transition-transform" href="#">AI Match</a>
                        <a className="text-on-surface-variant dark:text-outline hover:text-primary dark:hover:text-inverse-primary transition-colors font-label-sm text-label-sm hover:bg-primary-container/10 dark:hover:bg-primary-fixed/10 px-sm py-xs rounded-lg active:scale-95 transition-transform" href="#">Resources</a>
                    </div>
                    {/* Trailing Actions */}
                    <div className="flex items-center gap-sm">
                        ...
                        {/* Secondary Action */}
                        <a className="hidden lg:block text-primary font-label-sm text-label-sm hover:bg-primary-container/10 px-sm py-2 rounded-lg transition-all duration-300 active:scale-95 transition-transform" href="#">Sign In</a>
                        {/* Primary Action */}
                        <a className="bg-primary text-on-primary font-label-sm text-label-sm px-4 py-2 rounded-lg hover:bg-primary/90 transition-all duration-300 shadow-sm active:scale-95 transition-transform" href="#">Find a Puppy</a>
                        {/* Profile Placeholder (Mobile mainly) */}
                        <div className="md:hidden w-8 h-8 rounded-full bg-surface-container overflow-hidden">
                            <img alt="User profile avatar" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBZFh_XYPVVdqot5xoRi3iOPgAx9_1CXYyGeYoyDTlezQHcDKOI4WEvpFPAzLqLlcX6oSXBteCuxTQqxZoplGW2JL2OORaHWbCqPpbkIspADHDqMG2KXOZxW4d7o7rtRMoqQ-EVb80CaoYrmp6mGqU4to6burUVi3N3X9bi822HEtx-fUxhLXyC3sD0Zmp-9QqcL0HSRVNA-hln83GBvxIl17Vej0MS4nKivPKPynVNjiSDMeSew0yHAr_Gifu9kaLgmVFIfBMOWZIH" />
                        </div>
                    </div>
                </div>
            </nav>
                ...
                <section className="w-full max-w-5xl bg-surface-container-lowest rounded-[2rem] shadow-[0px_4px_20px_rgba(31,41,51,0.04),0px_2px_4px_rgba(31,41,51,0.02)] overflow-hidden flex flex-col md:flex-row relative">
                    ...
                    <div className="w-full md:w-5/12 min-h-[300px] md:min-h-auto relative bg-surface-container-low">
                        <div
                            ...
                            style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuB9Mt4i-G6iqnLUkZj535H2P1u2NvpySxEUlrDmtTNJHUmWbJWE5oQ-5ug7t3pO79wyAAhJPvaB3kWk-vR2scZudlS4d9_Pj_QslWEU3WUEo2M5x30vmJWwMzFDWa4GitKJOdg3DaYGf85JFNQHPf8TlzKH4Z5zTvthmcJ9_tzEpGd2jx8y13Hm0G0MeY9S52cN0VDdJf41qsTS_rXzQfmSdvOU04QfOfDyxSpno18Mpkz3WTZsgUP8T2_sVbA_qmYpPDKPJaSs6YNX')" }}
                        ></div>
                    ...
                    <div className="w-full md:w-7/12 p-gutter md:p-lg lg:p-xl flex flex-col justify-center relative z-10">
                        <div className="mb-md">
                            ...
                            <h1 className="font-display-lg text-display-lg text-on-surface mb-4 leading-tight">Let’s Find Your Perfect Dog</h1>
                            <p className="font-body-lg text-body-lg text-on-surface-variant max-w-md">
                                Answer a few quick questions so our AI can match you with the best breed for your lifestyle.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-sm mb-lg">
                            ...
                            <div className="flex items-center gap-3 bg-surface-container-low p-4 rounded-xl flex-1">
                                ...
                                <div>
                                    ...
                                    <p className="font-body-md text-body-md font-medium text-on-surface">3 Short Sections</p>
                                </div>
                            </div>
                        </div>
